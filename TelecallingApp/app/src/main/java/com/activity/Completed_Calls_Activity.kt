...
class Completed_Calls_Activity : AppCompatActivity() {
    private lateinit var statusSpinner: Spinner
    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: IntrestescallAdapter
    private lateinit var completedbackimge: ImageView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_completed_calls)

        statusSpinner = findViewById(R.id.called_dateOptionsSpinner)
        recyclerView = findViewById(R.id.completedrecyclerView)
        completedbackimge= findViewById(R.id.calledbackbutton_img)
...
//                callApi(period, "called")
            }

            override fun onNothingSelected(parent: AdapterView<*>) {}
        }
        completedbackimge.setOnClickListener {
            onBackPressed()
...
//                        runOnUiThread {
//                            if (leadList.isEmpty()) {
//                                Toast.makeText(this@Completed_Calls_Activity, "No Leads Found", Toast.LENGTH_SHORT).show()
//                            }
